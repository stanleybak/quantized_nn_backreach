...
def main():
    ...
    ###################
    alpha_prev_list = [3, 3, 3, 3, 3, 3, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 3, 0, 0]
    qtheta1 = -3
    qv_own = 8
    qv_int = 11
    # chebyshev center radius: 3.7107443726588054e-14
    end = np.array([462.69856049, 222.99525923, 193.03911762,  68.35873677,
             0.        , 300.        ])
    start = np.array([ -7087.20672643,     26.7836793 ,    204.15401217,    -16.06726921,
           -11100.        ,    300.        ])
