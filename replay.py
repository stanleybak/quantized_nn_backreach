...
def main():
    ...
    ###################
    alpha_prev_list = [4, 4, 4, 4, 4, 4, 4, 4, 4, 0, 0]
    qtheta1 = 124
    qv_own = 3
    qv_int = 0
    # chebyshev center radius: 0.5019665394445356
    end = np.array([ 250.50196654,  167.4138132 , -144.82495642,   51.81771739,
              0.        ,    0.50196654])
    start = np.array([ 1.76664795e+03,  3.91742097e+01, -1.52564732e+02, -1.95792301e+01,
           -5.01966539e+00,  5.01966539e-01])
