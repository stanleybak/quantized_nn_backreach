...
def main():
    ...
    ###################
    alpha_prev_list = [4, 4, 4, 4, 4, 4, 4, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 4, 3, 3, 0, 0]
    qtheta1 = 237
    qv_own = 8
    qv_int = 11
    # chebyshev center radius: 1.1367184834034767e-14
    end = np.array([ 461.91002811, -289.48291288,  184.79701543,  -76.54543008,
              0.        ,  300.        ])
    start = np.array([ -6499.1321514 ,     26.16080304,    199.40624445,    -15.69361179,
           -10500.        ,    300.        ])
    ##################
